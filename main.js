...
const translations = {
  pt: {
    ...
    aboutBody:
      "Sou estudante de dupla graduação em Engenharia de Software e Ciências Contábeis na UFU, combinando desenvolvimento de software com uma visão prática de conformidade financeira, retorno sobre investimento e eficiência operacional. Como estagiário de Engenharia de Software, atuo no ciclo completo de desenvolvimento, mantendo e otimizando sistemas críticos de negócio com foco em backends robustos, interfaces dinâmicas, código limpo e confiabilidade. <br /><br /><strong>Stack:</strong> Java com Spring Boot, Python, SQL, PL/SQL, JavaScript, TypeScript e React. Também tenho experiência com o Kenan Billing System, fluxos de dados complexos e regras de faturamento. <br /><br /><strong>Objetivo:</strong> aplicar minhas habilidades em Java e arquitetura de nuvem para construir soluções seguras, eficientes e orientadas a crescimento, enquanto avanço nas certificações AZ-900, AZ-104 e AZ-305.",
    skillJava: "Java",
    skillPython: "Python",
    ...
    certificationsPath: "AZ-900 · AZ-104 · AZ-305 (em andamento)",
  ...
  en: {
    ...
    certificationsPath: "AZ-900 · AZ-104 · AZ-305 (in progress)",
