...
const translations = {
  pt: {
    ...
    aboutLead:
      "Desenvolvimento sólido no backend. Arquitetura preparada para crescer.",
    aboutBody:
      "Minha atuação combina desenvolvimento backend com Java e Python, automação de processos, bancos de dados e evolução contínua em arquitetura de soluções na Microsoft Azure. Busco oportunidades nacionais e internacionais em que possa construir software confiável e aprender com problemas reais.",
    skillJava: "Java",
    skillPython: "Python",
  ...
  en: {
    ...
    aboutLead:
      "Solid backend development. Architecture built to scale.",
    aboutBody:
      "My work combines backend development with Java and Python, process automation, databases, and continuous growth in Microsoft Azure solution architecture. I'm looking for national and international opportunities where I can build reliable software and learn from real-world problems.",
    skillJava: "Java",
    skillPython: "Python",
